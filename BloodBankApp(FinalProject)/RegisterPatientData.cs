...
{
    class RegisterPatientData : RegPatInt 
    {
        private string name;
        ...
        public RegisterPatientData(string nameTxt, string fathersNameTxt, string ageTxt, string addressTxt, string phoneNoTxt, string dobTxt, string genderTxt, string bloodGroupTxt, string registerAsTxt)
        {
            name = nameTxt;
